...
public class V2v4 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("Program za polnjenje  tabele s \"Minolovskimi števili\" v poljubnem območju.");
		do {
	...
	{
		int vnos=0,zmnozekStevk=1,vsotaStevk=0;
		int[] tabela={};
		for(;n<=m;n++,vsotaStevk=0)
		{
			for(vnos=n;vnos!=0;vnos/=10)
			{
				for(int stevec=1;stevec<=vnos%10;stevec++)
				{
					zmnozekStevk*=stevec;
				}
