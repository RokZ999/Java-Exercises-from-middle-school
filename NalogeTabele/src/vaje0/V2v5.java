...
public class V2v5 
{
	public static void main(String[] args) 
	{
		...
		System.out.println("Program za polnjenje  tabele s \"Bombastična\" v poljubnem območju.");
		do {
	...
	{
		int dolzina = 0, vsotaStevk=0,zmnozekStevk=1,zacasna=0;
		int[] tabela={};
		for(;n<=m;n++,vsotaStevk=0)
		{
			zacasna=n;
			dolzina = String.valueOf(n).length();
			for(;zacasna!=0;zacasna/=10,dolzina--)
			{
				for(int stevec=1;stevec<=dolzina;stevec++)
				{
					zmnozekStevk*=zacasna%10;
				}
